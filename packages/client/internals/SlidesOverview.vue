...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="inline-block border border-gray-400 rounded border-opacity-50 overflow-hidden bg-main hover:border-$kolibry-theme-primary"
          :class="{ 'border-$kolibry-theme-primary': focus(idx + 1) }"
          @click="go(+route.path)"
        >
          <SlideContainer
            :key="route.path"
