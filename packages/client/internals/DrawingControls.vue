...
<template>
  <Draggable
    ...
    storage-key="enigmaslidev-drawing-pos"
    :initial-x="10"
    :initial-y="10"
  >
    <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode !== 'stylus' }" @click="setDrawingMode('stylus')">
      <HiddenText text="Draw with stylus" />
      <carbon:pen />
    </button>
    <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode !== 'line' }" @click="setDrawingMode('line')">
    ...
    <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode !== 'arrow' }" @click="setDrawingMode('arrow')">
      <HiddenText text="Draw an arrow" />
      <carbon:arrow-up-right />
    </button>
    <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode !== 'ellipse' }" @click="setDrawingMode('ellipse')">
      <HiddenText text="Draw an ellipse" />
      <carbon:radio-button />
    </button>
    <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode !== 'rectangle' }" @click="setDrawingMode('rectangle')">
      <HiddenText text="Draw a rectangle" />
      <carbon:checkbox />
    </button>
    <!-- TODO: not sure why it's not working! -->
    <!-- <button class="enigmaslidev-icon-btn" :class="{ shallow: drawingMode != 'eraseLine' }" @click="setDrawingMode('eraseLine')">
    ...
    <button class="enigmaslidev-icon-btn" :class="{ disabled: !canUndo }" @click="undo()">
      <HiddenText text="Undo" />
      <carbon:undo />
    </button>
    <button class="enigmaslidev-icon-btn" :class="{ disabled: !canRedo }" @click="redo()">
      <HiddenText text="Redo" />
      <carbon:redo />
    </button>
    <button class="enigmaslidev-icon-btn" :class="{ disabled: !canClear }" @click="clearDrauuIt()">
      <HiddenText text="Delete" />
      <carbon:delete />
    </button>

    <VerticalDivider />
    <button class="enigmaslidev-icon-btn" :class="{ shallow: !drawingPinned }" @click="drawingPinned = !drawingPinned">
