...
const size = useLocalStorage('enigmaslidev-webcam-size', Math.round(Math.min(window.innerHeight, (window.innerWidth) / 8)))
const position = useLocalStorage('enigmaslidev-webcam-pos', {
