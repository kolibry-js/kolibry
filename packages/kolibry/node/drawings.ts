...
function resolveDrawingsDir(options: ResolvedKolibryOptions): string | undefined {
...
export async function loadDrawings(options: ResolvedKolibryOptions) {
...
export async function writeDrawings(options: ResolvedKolibryOptions, drawing: Record<string, string>) {
  const dir = resolveDrawingsDir(options)
  if (!dir)
    return
