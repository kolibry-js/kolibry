...
import type { ShikiOptions } from '@kolibry/types'
import { encode } from 'plantuml-encoder'
import Mdc from 'markdown-it-mdc'
import type { KolibryPluginOptions, ResolvedKolibryOptions } from '../options'
...
export async function createMarkdownPlugin(
  { data: { config }, roots, mode, entry }: ResolvedKolibryOptions,
  { markdown: mdOptions }: KolibryPluginOptions,
): Promise<Plugin> {
