...
import type { KolibryPluginOptions, ResolvedKolibryOptions } from '..'
import { resolveImportPath } from '../utils'
import { loadSetups } from './setupNode'

export async function createWindiCSSPlugin(
  { themeRoots, addonRoots, clientRoot, userRoot, roots, data }: ResolvedKolibryOptions,
  { windicss: windiOptions }: KolibryPluginOptions,
) {
