...
export async function getIndexHtml({ clientRoot, themeRoots, addonRoots, data, userRoot }: ResolvedKolibryOptions): Promise<string> {
...
export async function mergeViteConfigs({ addonRoots, themeRoots }: ResolvedKolibryOptions, viteConfig: InlineConfig, config: InlineConfig, command: 'serve' | 'build') {
